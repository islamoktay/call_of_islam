...
@override
 ...
 Future<void> calculateCountdown() async {
    ...
    switch (PrayerTimesConstants.prayerTimes.nextPrayer()) {
      case Prayer.fajr:
        return buildCountdownText(nowTime, PrayerTimesConstants.prayerTimes.fajr.toLocal());
        break;
      case Prayer.sunrise:
        return buildCountdownText(nowTime, PrayerTimesConstants.prayerTimes.sunrise.toLocal());

        break;
      case Prayer.dhuhr:
        return buildCountdownText(nowTime, PrayerTimesConstants.prayerTimes.dhuhr.toLocal());

        break;
      case Prayer.asr:
        return buildCountdownText(nowTime, PrayerTimesConstants.prayerTimes.asr.toLocal());

        break;
      case Prayer.maghrib:
        return buildCountdownText(nowTime, PrayerTimesConstants.prayerTimes.maghrib.toLocal());

        break;
      case Prayer.isha:
        return buildCountdownText(nowTime, PrayerTimesConstants.prayerTimes.isha.toLocal());

        break;
      default:
        return buildCountdownText(
            nowTime, PrayerTimesConstants.prayerTimes.fajr.add(Duration(days: 1)).toLocal());
    }
  }
